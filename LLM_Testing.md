...
Other tricks : 
- Think about mixing languages within the same sentence
- Also consider homoglyphs: https://www.dcode.fr/generateur-homoglyphes-homographes
- A multi-turn jailbreak takes longer to set up but often has a higher chance of success
